...
module Byebug
  ...
  # source://byebug/12.0.0/lib/byebug/core.rb#31
  def displays; end

  # source://byebug/12.0.0/lib/byebug/core.rb#31
  def displays=(_arg0); end

  # source://byebug/12.0.0/lib/byebug/core.rb#25
  def init_file; end

  # source://byebug/12.0.0/lib/byebug/core.rb#25
  def init_file=(_arg0); end

  # source://byebug/12.0.0/lib/byebug/core.rb#41
  def mode; end

  # source://byebug/12.0.0/lib/byebug/core.rb#41
  def mode=(_arg0); end

  # source://byebug/12.0.0/lib/byebug/core.rb#52
  ...
  # source://byebug/12.0.0/lib/byebug/core.rb#102
  def rc_dirs; end

  # source://byebug/12.0.0/lib/byebug/core.rb#91
  ...
  class << self
    # source://byebug/12.0.0/lib/byebug/remote.rb#25
    def actual_control_port; end

    # source://byebug/12.0.0/lib/byebug/remote.rb#20
    def actual_port; end

    def add_catchpoint(_arg0); end

    # source://byebug/12.0.0/lib/byebug/attacher.rb#10
    def attach; end
    ...
    # source://byebug/12.0.0/lib/byebug/core.rb#76
    def handle_post_mortem; end

    # source://byebug/12.0.0/lib/byebug/remote.rb#32
    def interrupt; end

    # source://byebug/12.0.0/lib/byebug/core.rb#61
    def load_settings; end

    def lock; end

    # source://byebug/12.0.0/lib/byebug/remote.rb#59
    ...
    # source://byebug/12.0.0/lib/byebug/attacher.rb#21
    def spawn(host = T.unsafe(nil), port = T.unsafe(nil)); end

    def start; end

    # source://byebug/12.0.0/lib/byebug/remote.rb#55
    def start_client(host = T.unsafe(nil), port = T.unsafe(nil)); end

    # source://byebug/12.0.0/lib/byebug/remote.rb#48
    def start_control(host = T.unsafe(nil), port = T.unsafe(nil)); end

    # source://byebug/12.0.0/lib/byebug/remote.rb#39
    ...
    # source://byebug/12.0.0/lib/byebug/remote.rb#17
    ...
    # source://byebug/12.0.0/lib/byebug/remote.rb#66
    def client; end

    # source://byebug/12.0.0/lib/byebug/remote.rb#76
    def control; end

    # source://byebug/12.0.0/lib/byebug/remote.rb#70
    def server; end
  end
end
...
class Pry
  ...
  # source://pry/0.15.2/lib/pry/pry_instance.rb#80
  def initialize(options = T.unsafe(nil)); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#210
  def add_sticky_local(name, &block); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#34
  def backtrace; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#34
  def backtrace=(_arg0); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#31
  ...
  # source://pry/0.15.2/lib/pry/pry_instance.rb#143
  def complete(str); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#49
  def config; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#122
  def current_binding; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#122
  def current_context; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#32
  ...
  # source://pry/0.15.2/lib/pry/pry_instance.rb#253
  def eval(line, options = T.unsafe(nil)); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#33
  def eval_string; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#33
  def eval_string=(_arg0); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#284
  ...
  # source://pry/0.15.2/lib/pry/pry_instance.rb#392
  def exec_hook(name, *args, &block); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#41
  def exit_value; end
  ...
  # source://pry/0.15.2/lib/pry/pry_instance.rb#171
  def inject_local(name, value, binding); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#199
  ...
  # source://pry/0.15.2/lib/pry/pry_instance.rb#44
  def input_ring; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#38
  def last_dir; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#38
  def last_dir=(_arg0); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#40
  def last_exception; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#416
  def last_exception=(exception); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#37
  def last_file; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#37
  def last_file=(_arg0); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#36
  def last_result; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#36
  def last_result=(_arg0); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#438
  def last_result_is_exception?; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#188
  def memory_size; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#193
  def memory_size=(size); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#508
  def output; end

  # source://forwardable/1.3.3/forwardable.rb#231
  def output=(*args, **_arg1, &block); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#47
  def output_ring; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#500
  def pager; end

  # source://forwardable/1.3.3/forwardable.rb#231
  def pager=(*args, **_arg1, &block); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#492
  def pop_prompt; end
  ...
  # source://pry/0.15.2/lib/pry/pry_instance.rb#323
  def process_command(val); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#358
  def process_command_safely(val); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#99
  def prompt; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#106
  def prompt=(new_prompt); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#129
  def push_binding(object); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#116
  def push_initial_binding(target = T.unsafe(nil)); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#476
  def push_prompt(new_prompt); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#562
  def quiet?; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#552
  def raise_up(*args); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#556
  def raise_up!(*args); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#524
  def raise_up_common(force, *args); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#280
  def repl(target = T.unsafe(nil)); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#229
  def reset_eval_string; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#373
  def run_command(val); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#451
  def select_prompt; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#407
  def set_last_result(result, code = T.unsafe(nil)); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#445
  def should_print?; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#296
  def show_result(result); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#214
  def sticky_locals; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#35
  def suppress_output; end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#35
  def suppress_output=(_arg0); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#426
  def update_input_history(code); end

  private

  # source://pry/0.15.2/lib/pry/pry_instance.rb#650
  def ensure_correct_encoding!(val); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#568
  def handle_line(line, options); end

  # source://pry/0.15.2/lib/pry/pry_instance.rb#659
  def prompt_stack; end

  class << self
    # source://pry/0.15.2/lib/pry/code.rb#12
    def Code(obj); end

    # source://pry/0.15.2/lib/pry/method.rb#9
    def Method(obj); end

    # source://pry/0.15.2/lib/pry/wrapped_module.rb#7
    def WrappedModule(obj); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#296
    def auto_resize!; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#349
    def binding_for(target); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#22
    def cli; end
    ...
    # source://pry/0.15.2/lib/pry/pry_class.rb#25
    def config; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#25
    def config=(_arg0); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#46
    def configure; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#382
    def critical_section; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#63
    def current; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#19
    def current_line; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#19
    def current_line=(_arg0); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#18
    def custom_completions; end
    ...
    # source://pry/0.15.2/lib/pry/pry_class.rb#21
    def eval_path; end
    ...
    # source://pry/0.15.2/lib/pry/pry_class.rb#139
    ...
    # source://pry/0.15.2/lib/pry/pry_class.rb#377
    def in_critical_section?; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#340
    def init; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#259
    def initial_session?; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#129
    ...
    # source://pry/0.15.2/lib/pry/pry_class.rb#24
    def last_internal_error; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#24
    def last_internal_error=(_arg0); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#20
    def line_buffer; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#20
    def line_buffer=(_arg0); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#69
    def load_file_at_toplevel(file); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#204
    def load_file_through_repl(file_name); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#253
    def load_history; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#77
    def load_rc_files; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#101
    def load_requires; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#109
    def load_traps; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#113
    def load_win32console; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#55
    def main; end
    ...
    # source://pry/0.15.2/lib/pry/pry_class.rb#23
    def quiet; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#23
    def quiet=(_arg0); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#86
    def rc_files_to_load; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#94
    def real_path_to(file); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#328
    def reset_defaults; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#279
    def run_command(command_string, options = T.unsafe(nil)); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#156
    def start(target = T.unsafe(nil), options = T.unsafe(nil)); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#356
    def toplevel_binding; end

    # source://pry/0.15.2/lib/pry/pry_class.rb#374
    def toplevel_binding=(_arg0); end

    # source://pry/0.15.2/lib/pry/pry_class.rb#227
    def view_clip(obj, options = T.unsafe(nil)); end

    private

    # source://pry/0.15.2/lib/pry/pry_class.rb#390
...
class Pry::REPL
  ...
  # source://pry/0.15.2/lib/pry/repl.rb#22
  ...
  # source://pry/0.15.2/lib/pry/repl.rb#9
  def pry; end

  # source://pry/0.15.2/lib/pry/repl.rb#9
  def pry=(_arg0); end

  # source://pry/0.15.2/lib/pry/repl.rb#36
  def start; end

  private

  # source://pry/0.15.2/lib/pry/repl.rb#307
  def calculate_overhang(current_prompt, original_val, indented_val); end

  # source://pry/0.15.2/lib/pry/repl.rb#287
  def complete_expression?(multiline_input); end

  # source://pry/0.15.2/lib/pry/repl.rb#246
  def coolline_available?; end

  # source://pry/0.15.2/lib/pry/repl.rb#84
  def epilogue; end

  # source://pry/0.15.2/lib/pry/repl.rb#127
  def handle_read_errors; end

  # source://pry/0.15.2/lib/pry/repl.rb#234
  def input_multiline?; end

  # source://pry/0.15.2/lib/pry/repl.rb#228
  def input_readline(*args); end

  # source://pry/0.15.2/lib/pry/repl.rb#219
  def input_readmultiline(*args); end

  # source://pry/0.15.2/lib/pry/repl.rb#272
  def piping?; end

  # source://pry/0.15.2/lib/pry/repl.rb#250
  def prism_available?; end

  # source://pry/0.15.2/lib/pry/repl.rb#47
  def prologue; end

  # source://pry/0.15.2/lib/pry/repl.rb#93
  def read; end

  # source://pry/0.15.2/lib/pry/repl.rb#169
  def read_line(current_prompt); end

  # source://pry/0.15.2/lib/pry/repl.rb#242
  def readline_available?; end

  # source://pry/0.15.2/lib/pry/repl.rb#238
  def reline_available?; end

  # source://pry/0.15.2/lib/pry/repl.rb#66
  def repl; end

  # source://pry/0.15.2/lib/pry/repl.rb#279
  ...
  class << self
    ...
    # source://pry/0.15.2/lib/pry/repl.rb#14
